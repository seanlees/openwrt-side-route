...
CHECK_TIMEOUT="15"
#临时变量
route_table_num_tmp=$(uci -q get $TMP_CONFIG.global.route_table_num_tmp)
route_side_ip_tmp=$(uci -q get $TMP_CONFIG.global.route_side_ip_tmp)
route_interface_tmp=$(uci -q get $TMP_CONFIG.global.route_interface_tmp)
route_mark_tmp=$(uci -q get $TMP_CONFIG.global.route_mark_tmp)
lcheck_timeout_tmp=$(uci -q get $TMP_CONFIG.global.check_timeout_tmp)
