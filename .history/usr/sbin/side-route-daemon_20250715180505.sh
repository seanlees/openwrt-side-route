...
ROUTE_TABLE_NUM_OLD=""
ROUTE_SITE_IP_OLD=""
ROUTE_INTERFACE_OLD=""check_timeout_tmp=""
...
reload_config() {
    ...
    local ROUTE_SITE_IP_OLD=$(uci -q get $TMP_CONFIG.global.route_side_ip)
    local ROUTE_INTERFACE_OLD=$(uci -q get $TMP_CONFIG.global.route_interface)
