...
device_section.anonymous = false  -- 不显示节名称
...
-- 显示 section 名称（即使 anonymous = true）
device_section:option(DummyValue, ".name", translate("Section")).cfgvalue = function(self, section)
    return section
end
-- 设备名称
