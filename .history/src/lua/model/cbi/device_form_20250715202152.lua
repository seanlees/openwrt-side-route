...
-- IP 地址
local device_ip = s:option(Combobox, "ip", translate("IP Address"))
device_ip.datatype = "ipaddr"
device_ip.rmempty = false
device_ip.placeholder = translate("Enter IP or select from list")
device_ip:value("192.168.1.1", "192.168.1.1 (Router)")
device_ip:value("192.168.1.100", "192.168.1.100 (My PC)")
device_ip:value("192.168.1.254", "192.168.1.254 (Gateway)")
