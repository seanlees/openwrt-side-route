...
local device_table = custom_section:tab("device_table", translate("Device List"))

-- 添加表头
local header_row = device_table:row()
header_row:cell("th", translate("Enable"))
header_row:cell("th", translate("Name"))
header_row:cell("th", translate("IP Address"))
