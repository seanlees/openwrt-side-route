...
cancel.inputstyle = "reset"
cancel.action = luci.dispatcher.build_url("admin/services/side_route")

local cancel = s:option(DummyValue, "_cancel", translate("Cancel"))
cancel.template = "cbi/dvalue"
cancel.value = translate("Cancel")
cancel.onclick = function()
    return "location.href='"..luci.dispatcher.build_url("admin/services/side_route").."'"
end
